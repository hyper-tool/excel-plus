@extends('excels._layout')

@section('content')
    <div class="search">
        @include('excels._search')
    </div>
    <div class="stripe">
        @include('excels._stripe')
    </div>
    <div class="table">
        @include('excels._list')
    </div>
    <div class="page">
        @include('excels._page')
    </div>
@endsection
    ...
    <script>
        ...
        var mixin = {
            ...
            methods: {
                ...
                alertThis(excel_this) {
                    console.log(excel_this)
                },
                deleteRow(id) {
                    axios.delete('/excels/' + id)
                        .then(
                            (response) => {
                ...
                reload() {
                    ...
                    axios.get('/excels/', {params: request_parameter})
                        .then((response) => {
